...
const Navbar = () => {
  ...
  return (
    <div className={`${styles.paddingX} ${styles.flexCenter} ${fix ? 'navbar fixed' : 'navbar'} w-full`}>
      <div className={`${styles.boxWidth}`}>
        <nav className={`w-full flex py-6 justify-between items-center`}>
          <img src={brand} alt="PasionJP" className="w-[124px] h-[32px]"/>
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
            <img 
              ...
              alt="menu"
              className="w-[28px] h-[28px] object-contain justify-end"
